 ...
 */
class changeEnemyMpCommand extends abstractCommand
{
    ...
    public function getParametersDescription(): string
    {
        ...
        switch ($this->getOperator()) {
            ...
            case self::OPERATOR_DECREASE:
                ...
                break;
            default:
                throw new \Exception("Unknown modify enemy mp operator type '{$this->getOperator()}'");
        }
        ...
        switch ($this->getOperandType()) {
            ...
            case self::OPERAND_VARIABLE:
                ...
                break;
            default:
                throw new \Exception("Unknown modify enemy mp operand type '{$this->getOperandType()}'");
        }
