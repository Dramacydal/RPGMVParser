 ...
 */
class changeTpCommand extends abstractCommand
{
    ...
    public function getParametersDescription(): string
    {
        ...
        switch ($this->getSourceType()) {
            ...
            case self::SOURCE_TYPE_VARIABLE:
                ...
                break;
            default:
                throw new \Exception("Unknown modify tp source type '{$this->getSourceType()}'");
        }
        ...
        switch ($this->getOperator()) {
            ...
            case self::OPERATOR_DECREASE:
                ...
                break;
            default:
                throw new \Exception("Unknown modify tp operator type '{$this->getOperator()}'");
        }
        ...
        switch ($this->getOperandType()) {
            ...
            case self::OPERAND_VARIABLE:
                ...
                break;
            default:
                throw new \Exception("Unknown modify tp operand type '{$this->getOperandType()}'");
        }
