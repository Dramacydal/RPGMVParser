 ...
 */
class changeLevelCommand extends abstractCommand
{
    ...
    public function getParametersDescription(): string
    {
        ...
        switch ($this->getSourceType()) {
            ...
            case self::SOURCE_TYPE_VARIABLE:
                ...
                break;
            default:
                throw new \Exception("Unknown change level source type '{$this->getSourceType()}'");
        }
        ...
        switch ($this->getOperator()) {
            ...
            case self::OPERATOR_DECREASE:
                ...
                break;
            default:
                throw new \Exception("Unknown change level operator type '{$this->getOperator()}'");
        }
        ...
        switch ($this->getOperandType()) {
            ...
            case self::OPERAND_VARIABLE:
                ...
                break;
            default:
                throw new \Exception("Unknown change level operand type '{$this->getOperandType()}'");
        }
